...
// Apache-DButils.jar
//C3p0Util = C3P0连接池 + Dbutils增删改查  

public class C3p0Util {
	//私有化静态常量
	private static ComboPooledDataSource dataSource=new ComboPooledDataSource("dataSources");//单例模式
	...
	public static int update(String sql,Object...params)
			throws SQLException{
		System.out.println("获取连接Dbutil里的更新方法");
