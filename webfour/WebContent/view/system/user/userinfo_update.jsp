				...
				<div class="form-group ">
					...
					<div class="col-xs-4 ">
						<select name="roleId" class="form-control">
							<option ${user.roleId=='1'?'selected':'' } value="1" >普通员工</option>
							<option ${user.roleId=='2'?'selected':'' } value="2" >部门经理</option>
							<option  ${user.roleId=='3'?'selected':''} value="3" >财务人员</option>
							<option  ${user.roleId=='4'?'selected':''} value="4" >超级管理员</option>
						</select>
					</div>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-xs-5">
				<div class="form-group ">
					...
					<div class="col-xs-9">
						<input type="text" class="form-control" name="userAccount"  readonly="readonly" value="${user.userAccount }"  id="userAccount" placeholder="请输入用户账号" />
