...
<body>
	...
	<form action="finance/payFinance" id="f1" method="post"
		...
		<div class="row">
			<div class="col-xs-9">
				<div class="form-group ">
					...
					<div class="col-xs-3 ">
						<input type="text" class="form-control" required  name="salaryMonth" value='<fmt:formatDate value="${salary.salaryMonth }" pattern="yyyy-MM-dd"/>' onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" placeholder="请输入发放月份" />
					</div>
				</div>
			</div>
			<div class="col-xs-9">
...
<%-- 							required name="userSalary" id="salaryBasic" value="${user.userSalary }" --%>
