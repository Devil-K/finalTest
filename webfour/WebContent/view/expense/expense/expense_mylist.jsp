...
<div>
	...
	<form action="expense/showExpenseDetail" id="f1" method="post" class="form-inline">
		...
		<div class="row" style="padding: 15px;">
			<d:table class="table table-hover table-condensed" name="list" pagesize="10" requestURI="expense/queryMyExpenses">
				...
				<d:column property="expenseToltel" title="报销总金额"></d:column>			
				<d:column value="详情" title="查看详情" href="expense/showExpenseDetail"  paramId="expenseId" paramProperty="expenseId"></d:column>
